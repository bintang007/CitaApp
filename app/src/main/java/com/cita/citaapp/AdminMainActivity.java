...
import com.cita.citaapp.ui.home.admin.HomeFragment;
import com.cita.citaapp.ui.nutrient.admin.NutrientFragment;
import com.cita.citaapp.ui.profile.admin.ProfileFragment;
...
public class AdminMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adminId = getIntent().getIntExtra(LoginActivity.TAG_ADMIN_ID, 0);
        ...
        activityTitles = getResources().getStringArray(R.array.nav_item_admin_activity_titles);
...
//        sharedPreferences = getSharedPreferences(LoginActivity.MY_SHARED_PREFERENCES, Context.MODE_PRIVATE);
    ...
    private void loadNavHeader() {
        ...
        AppController.getInstance().addToRequestQueue(stringRequest, TAG, getApplicationContext());
    ...
    private Fragment getFragment() {
        switch (navItemIndex) {
            case 1:
                ...
                bundleProfile.putInt(LoginActivity.TAG_ADMIN_ID,
                        getIntent().getIntExtra(LoginActivity.TAG_ADMIN_ID, 0));
            ...
            case 2:
                ...
                bundleNutrient.putInt(LoginActivity.TAG_ADMIN_ID,
                        getIntent().getIntExtra(LoginActivity.TAG_ADMIN_ID, 0));
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_policy:
                        ...
                        Toast.makeText(AdminMainActivity.this, "Lagi otw...", Toast.LENGTH_SHORT).show();
                        drawer.closeDrawers();
                        return true;
                    default:
                        navItemIndex = 0;
